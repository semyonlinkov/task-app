		...
		<div className={styles.wrapper}>
			<div className={styles.messages_area}>
				<div className={`${styles.message} ${styles.my_message}`}>
					<Avatar src={''} />
					<Message message={''} readed={true} name={'Иван Иванов Иванович'} date={'12.12.1212'} />
				</div>
				<div className={`${styles.message} ${styles.another_message}`}>
					<Avatar src={''} />
					<Message message={''} readed={true} name={'Петр Петров Петрович'} date={'12.12.1212'} />
				</div>
				<div className={`${styles.message} ${styles.my_message}`}>
					<Avatar src={''} />
					<Message message={''} readed={false} name={'Иван Иванов Иванович'} date={'12.12.1212'} />
				</div>
			</div>
